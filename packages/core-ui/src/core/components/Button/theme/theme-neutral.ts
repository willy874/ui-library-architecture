...
export const text: SystemStyleObject = {
  '--colors-button-text': '{colors.button.neutral.default}',
  '--colors-button-text-hover': 'color-mix(in oklch, {colors.button.neutral.default} 70%, #000)',
  '--colors-button-text-active': 'color-mix(in oklch, {colors.button.neutral.default} 70%,  #fff)',
  '--colors-button-text-disabled':
    'color-mix(in oklch, {colors.button.neutral.default} 60%, transparent)',
  '--colors-button-outline-focus':
    'color-mix(in oklch, {colors.button.neutral.default} 30%, transparent)',

...
export const atomicTokens = defineTokens({
  spacing: {
    '0': { value: '0' },
    '0.5': { value: '0.125rem' },
    '1': { value: '0.25rem' },
  ...
  shadows: {
    box: {
      '2xs': { value: '0 1px rgba(0, 0, 0, 0.05)' },
      sm: { value: '0 1px 2px 0 rgb(0 0 0 / 0.05)' },
      md: { value: '0 4px 8px 0 rgb(0 0 0 / 0.1)' },
      lg: { value: '0 8px 16px 0 rgb(0 0 0 / 0.2)' },
      xl: { value: '0 16px 32px 0 rgb(0 0 0 / 0.3)' },
      '2xl': { value: '0 32px 64px 0 rgb(0 0 0 / 0.4)' },
    },
    inset: {
    ...
    text: {
      '2xs': { value: '0px 1px 0px rgb(0 0 0 / 0.15)' },
      xs: { value: '0px 1px 1px rgb(0 0 0 / 0.2)' },
      sm: {
        value:
